...
def compute_lens_corrected_travel_times(
    element_pos, scat_pos, lens_thickness, c_lens, c_medium, n_iter=1
):
    ...
    Args:
        ...
        scat_pos (ndarray): The position of the pixel of shape (n_pixels, 3).
    ...
    scat_pos = scat_pos[:, None] - element_pos[None]
